...
class Mosaic(BaseMixTransform):
    ...
    def _mix_transform(self, labels):
        ...
        yc, xc = 320, 320  # mosaic center x, y
        for i in range(4):
...
class RandomPerspective:
    ...
    def __init__(self, degrees=0.0, translate=0.1, scale=0.9, shear=0.0, perspective=0.0, border=(0, 0)):
    ...
    def affine_transform(self, img):
        ...
        s = random.uniform(1 - self.scale, 0.6)
